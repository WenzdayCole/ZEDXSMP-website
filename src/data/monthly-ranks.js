...
export const monthlyRanks = [
  {
    ...
    popular: false,
    description:
      "Monthly VIP LuckPerms group for 30 days — yellow VIP tag, 3 homes, 10 orders, 10 AH listings, and quality-of-life commands.",
  ...
  },
  {
    ...
    popular: true,
    description:
      "Monthly MVP LuckPerms group for 30 days — includes all VIP perks plus golden MVP tag, 4 homes, 20 orders, 20 AH, and 1.5× shard earnings.",
    ...
    perks: [
      ...
      "All VIP permissions and commands",
    ],
    storeFeatures: [
  ...
  },
  {
    ...
    popular: false,
    description:
      "Top-tier ZEDX+ LuckPerms group for 30 days — all MVP and VIP perks, exclusive tag, 5 homes, 30 orders, 30 AH, 2× shards, and premium commands.",
    commands: [
      "/rtp",
      "/shop",
      "/pvp",
    ...
    perks: [
      ...
      "All MVP and VIP permissions and commands",
      "/craft, /enderchest",
    ],
    storeFeatures: [
