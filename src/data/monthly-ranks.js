...
export const monthlyRanks = [
  {
    ...
    popular: false,
    description:
      "Monthly VIP LuckPerms group for 30 days — yellow VIP tag, 3 homes, 10 orders, 10 AH, and the VIP kit.",
    commands: [],
    perks: [
  ...
  },
  {
    ...
    popular: true,
    description:
      "Monthly MVP LuckPerms group for 30 days — includes all VIP perks plus golden MVP tag, 5 homes, 20 orders, 20 AH, and the MVP kit.",
