/** Refund Policy sections for /refund */
export const refundSections = [
  ...
  },
  {
    ...
    paragraphs: [
      "Initiating a chargeback, payment reversal, or dispute without first contacting ZEDX SMP support may result in immediate suspension or termination of the associated account and revocation of all purchased content.",
      "ZEDX SMP reserves the right to contest chargebacks and provide relevant evidence to payment providers and financial institutions.",
    ],
  },
  {
    title: "5. Exceptional Refunds",
    paragraphs: [
      "In exceptional circumstances, ZEDX SMP may, at its sole discretion, offer a refund or compensation. Any such decision does not establish a precedent or obligation for future cases.",
    ],
  },
  {
  ...
  },
  {
    ...
    contact: {
      label: "Discord",
      href: "https://discord.com/invite/zedxsmp",
    },
  },
];
